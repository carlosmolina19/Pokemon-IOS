...
final class RemotePokemonSpecieRepositoryImplTests: XCTestCase {
    
    // MARK: - Private Typealias
    
    private typealias SUT = RemotePokemonSpecieRepositoryImpl
    ...
    func test_fetch_shouldReturnValues() throws {
        ...
        let url = try XCTUnwrap(URL(string: "https://pokeapi.co/api/v2/pokemon-species/1/"))
